...
export const selectFlippedCards = createSelector(
  selectGameState,
  (state: GameState) => state.flippedCards,
)

export const selectMatchedPairs = createSelector(
  selectGameState,
  (state: GameState) => state.matchedPairs,
)

export const selectTotalPairs = createSelector(
  selectGameState,
  (state: GameState) => state.totalPairs,
)
...
export const selectSelectedCategory = createSelector(
  selectGameState,
  (state: GameState) => state.selectedCategory,
)
